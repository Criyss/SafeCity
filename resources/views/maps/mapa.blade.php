...
<head>
    ...
    <style>
        ...
        #sidebar { width: 280px; min-width: 280px; background: white; box-shadow: 2px 0 5px rgba(0,0,0,0.1); padding: 20px; overflow-y: auto; }
...
<body>
    ...
    <script>
        ...
        var marcadores = [
            {lat: -16.5, lng: -68.15, titulo: 'Robo en La Paz', categoria: 'Robo', color: 'red'},
            {lat: -17.39, lng: -66.16, titulo: 'Accidente en Cochabamba', categoria: 'Accidente', color: 'blue'},
            {lat: -17.78, lng: -63.18, titulo: 'Vandalismo en Santa Cruz', categoria: 'Vandalismo', color: 'orange'},
            {lat: -19.58, lng: -65.75, titulo: 'Bache en Potosí', categoria: 'Bache', color: 'green'},
        ];
