...
<body>
    ...
    <div class="container py-4" style="max-width: 600px;">
        <h4 class="fw-bold mb-4" style="color: #1A3A5C;">Editar Categoría</h4>
            ...
            <div class="card-body">
                <form action="/categorias/{{ $categoria->id }}/update" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn text-white w-100" style="background-color: #1A3A5C;">Actualizar categoría</button>
