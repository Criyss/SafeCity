...
<head>
    ...
    <title>Safe City — Editar Usuario</title>
...
<body>
    ...
    <div class="container py-4" style="max-width: 600px;">
        <h4 class="fw-bold mb-4" style="color: #1A3A5C;">Editar Usuario</h4>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="/usuarios/{{ $user->id }}/update" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn text-white w-100" style="background-color: #1A3A5C;">Actualizar usuario</button>
